...
class CustomTextField: UIView {
    ...
    init(placeHolder: String = "NONE", isPassField: Bool = false, addErrorFunction: Bool = false, backgroundColorField: UIColor = .secondarySystemBackground) {
    ...
    private func setupTextFieldContainer() {
        ...
        containerTextField.addAnchorsAndSize(width: nil, height: nil, left: 0, top: 5, right: 0, bottom: 5, withAnchor: nil, relativeToView: nil)
        containerTextField.layer.cornerRadius = 5.0
